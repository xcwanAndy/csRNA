...
struct ibv_wqe *IbvTestServer::init_rdma_write_wqe (struct rdma_resc *res, struct ibv_mr* lmr, uint64_t raddr, uint32_t rkey) {
...
int IbvTestServer::main () {
    ...
    DPRINTF(IbvTestServer, "[test requester] ibv_post_send!\n");
